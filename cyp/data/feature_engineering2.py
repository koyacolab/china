...
class Engineer2:
    ...
    def __init__(
        ...
        yield_data = load(yield_data_filepath)[
            ["Year", "State", "County", "Value", "AreaWeight"]
        ]
        yield_data.columns = ["Year", "State", "County", "Value", "Area"]
    ...
    def process(
        ...
        for yield_data in self.yield_data.itertuples():
            ...
            if filename in self.processed_files:
                ...
                print(
                    f"County: {int(county)}, State: {state}, Year: {year}, Output shape: {image.shape}, area: {area}"
                )
